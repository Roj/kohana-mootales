...
[-] dashboard (need to add notifications, etc)  <br/>
[-] user profiles (- need to do the stats thing, threads, user info, ping, etc)  <br/>
[-] update user stats all the time (pageviews etc)  <br/>
[-] manage blogs (mark as draft, rename, edit, delete)  <br/>
[ ] edit comments, delete 'em  <br/>
[ ] quote functionality  <br/>
[ ] textarea buttons (bbcode, emoticons, etc)  <br/>
[ ] picture blogs  <br/>
[ ] mail  <br/>
[ ] friendship  <br/>
[ ] admin cp  <br/>
...
[ ] do not submit comments full of spaces<br/>
